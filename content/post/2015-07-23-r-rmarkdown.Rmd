...
In what typically would have been rising counts of marriage licenses issued, instead counts fell in March 2020 and continued falling in April 2020, where an all-time low (for this dataset) number of marriage licenses were issued: only 47. In subsequent months, the number of licenses slowly crept back up reaching approximately 1400 marriage licenses issued per month in July and August compared to typical peaks in the previous nine years for July and August of around 2000+ marriage licenses issued per month. Numerically, 30% fewer licenses were issued this year in July and August compared to the previous nine years. 

From the lack of data from some of the civic centers over the past few months, presumably they were closed and thus issued 0 marriage licenses. This further disrupted previously observed civic center trends with counts of licenses issued by North York Civic Center and Etobicoke Civic Center higher than they have ever been (in the past 9 years) because they were the only two locations open. 

# Data Analysis and Discussion
In Figure \@ref(fig:recent),
```{r agg, fig.width=10.5, fig.height=3, fig.cap='A plot of the number of marriage licenses issued aggregated per month over the past nine years.', echo=FALSE}
...
ggplot(data=agg_marriage_license, aes(x=TIME_PERIOD, y=TOTAL_MARRIAGE_LICENSES, group = 1)) +
  ...
  theme(axis.text.x = element_text(angle = 90, vjust=0.5, hjust=1))+ 
  xlab("Time Period") +
  ylab("Aggregated Marriage License Counts") 
```
